...
@Service
public class LoanDeleteTeacherService implements IDeleteLoanService{
    @Autowired
    ...
    public ResponseDto deleteLoan(LoanBookManagerDto loanBookManagerDto) {
        try{
            ...
            loansTeacherRepository.deleteById(loanBookManagerDto.getLoanUserDto().getIdLoanUserDto());
